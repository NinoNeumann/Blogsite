:root {
  ...
  --color-calendar-graph-day-L1-bg: #FFD54F;
  --color-calendar-graph-day-L2-bg: #FFC107;
  --color-calendar-graph-day-L3-bg: #FFA000;
  --color-calendar-graph-day-L4-bg: #FF6F00;
  --color-calendar-graph-text: #000000;
}
...
text.ContributionCalendar-label {
    /*fill: #ccc;*/
    fill: var(--color-calendar-graph-text);
    font-size: 11px;
}
